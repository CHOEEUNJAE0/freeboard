...
public class BoardController {
	...
	public String BoardUploadPost (BoardsVO boards) {
		...
		boards.setBoard_classification("sfdsf");
		boards.setClassification("sfdsf");
		boards.setUse_yn("Y");
	...
	//수정 페이지로 이동 조회페이지 이동 메서드와 동일 /수정하고자 하는 내용을 출력해야하기 때문에 int형 파라미터와 해당 게시판의 
